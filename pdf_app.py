...
now_month = nowaday.month
now_year = nowaday.year
...
start_date, finish_date = st.date_input('Введите даты начала и окончания проекта:', (current_day, nowaday), format='DD.MM.YYYY')
