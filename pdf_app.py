...
# text of letter
text_1 = f'IT Мастерская в лице её руководителя Богданова Руслана Александровича благодарит вас за отличную работу над проектом «{project_name}» с {start_date} по {finish_date} гг.'
text_2 = 'Отдельное спасибо за вашу вовлеченность, творческий подход \nк поиску оптимального решения и проявленный профессионализм.'
...
if students_raw is not None:
    ...
    for student in students:
        ...
        can.setFillColor('white')
        can.drawString(485, 64, f"{nowaday.strftime('%d.%m.%Y')} г.")
