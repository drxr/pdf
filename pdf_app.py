...
# text of letter
text_1 = f'Мастерская данных в лице руководителя отдела аналитики и разработки Богданова Руслана Александровича благодарит вас за отличную работу над проектом «{project_name}» с {start_date} по {finish_date}.'
